...
public class bicubic  {
    ...
    public void filter(BufferedImage src, BufferedImage dest) {
        ...
        this.destH = dest.getHeight();
        this.destW = dest.getWidth();
...
//        return dest;
    ...
    private void getRGB(BufferedImage src, int xstart, int ystart, int width, int height, int[] inPixels){
        for(int i=xstart; i<width+xstart;i++){
            for(int j=ystart; j<height+ystart;j++){
                inPixels[j*width+i] = src.getRGB(i,j);
            }
        }
    }
    private void setRGB(BufferedImage src, int xstart, int ystart, int width, int height, int[] inPixels){
        for(int i=xstart; i<width+xstart;i++){
            for(int j=ystart; j<height+ystart;j++){
                src.setRGB(i,j,inPixels[j*width+i]);
            }
        }
    }
}